...
const invoicesRoutes = require('./admin/routes/invoices');
const subscriptionPlansRoutes = require('./admin/routes/subscriptionPlans');
...
app.use("/api/admin/subscriptionPlans", subscriptionPlansRoutes);
